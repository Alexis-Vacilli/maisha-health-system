  ...
  return (
    <div className="flex justify-between items-center w-11/12 py-6 border-b-2 border-whiteTheme-purpleAccent">
      ...
      <div className="flex gap-5">
        ...
        <button className="border border-whiteTheme-greenColor py-2 px-5 text-whiteTheme-greenColor rounded-md">Excel</button>
        <button className="border border-whiteTheme-orangeAccent py-2 px-5 text-whiteTheme-orangeAccent rounded-md">PDF</button>
      </div>
    </div>
  );
};
